...
function find_portal(traveler, destination_coordinates)
    if destination_coordinates.surface == "nauvis" then
        ...
        if game.surfaces["nauvis"].is_chunk_generated(chunk_position) then
            ...
            if found_portals[1] then
                local closest_portal = game.surfaces["nauvis"].get_closest(destination_coordinates.position,
                    found_portals)
    ...
    elseif destination_coordinates.surface == "nether" then
        ...
        if game.surfaces["nether"].is_chunk_generated(chunk_position) then
            ...
            if found_portals[1] then
                local closest_portal = game.surfaces["nether"].get_closest(destination_coordinates.position,
                    found_portals)
...
function create_portal(traveler, destination_coordinates)
    if destination_coordinates.surface == "nauvis" then
        local new_portal_position = game.surfaces["nauvis"].find_non_colliding_position("nether-portal",
            destination_coordinates.position, 0, 1, true)
        ...
        return new_portal
    elseif destination_coordinates.surface == "nether" then
        local new_portal_position = game.surfaces["nether"].find_non_colliding_position("nether-portal",
            destination_coordinates.position, 0, 1, true)
